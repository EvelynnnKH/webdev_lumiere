...
<div class="order-details-page py-5">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div>
                    <span class="order-number fw-bold">Order #{{ $order->order_number }}</span>
                ...
                <div class="row mb-4" style="color: #5c3c1d;">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mt-3">
                            ...
                            <p><strong>Status:      <span class="order-detail-badge {{ 'badge-' . strtolower($order->status) }}">
                                    {{ $order->status }}
                                </span></strong></p>
                        </div>
                ...
                <table class="products-table table mb-4" style="color: #5c3c1d;">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td class="text-end" style="color: #5c3c1d;">Rp. {{ number_format($order->subtotal, 0, ',', '.') }},-</td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-end" style="color: #5c3c1d;">Tax (10%)</td>
                            <td class="text-end" style="color: #5c3c1d;">Rp. {{ number_format($order->taxAmount, 0, ',', '.') }},-</td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-end" style="color: #5c3c1d;">Shipping Cost</td>
                            <td class="text-end" style="color: #5c3c1d;">Rp. {{ number_format($order->shippingCost, 0, ',', '.') }},-</td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-end" style="color: #5c3c1d;">Admin Fee</td>
                            <td class="text-end" style="color: #5c3c1d;">Rp. {{ number_format($order->adminCost, 0, ',', '.') }},-</td>
                        </tr>
                        <tr class="fw-bold">
                            <td colspan="3" class="text-end" style="color: #5c3c1d;">Total</td>
                            <td class="text-end" style="color: #5c3c1d;">Rp. {{ number_format($order->total_price, 0, ',', '.') }},-</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
